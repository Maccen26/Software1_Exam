...
Background: 
    ...
    And the project 20251 has an activity with name: "Activity1", start week: 10, start year: 2025, end week: 20, end year: 2025 and budgetted time: 20 hours
...
Scenario: Trying to edit an activity when not the projectleader
    ...
    When "mahh" edits the budgetted time of "Activiy1" to 25 hours
